...
**对于Cloud flare workers项目**：添加自定义域然后和Pages一样配置，也可以通过路由配置
...
### workers路由配置优选  
在workers项目设置里加一条路由，域选你想让用户访问的域，路由就行你想让用户实际访问的子域，然后给那个子域再写一条cname到优选域名就行
...
# 至此，你的网站就会很绿了（联通还是算了吧，优选了一样烂  
![image.png](https://imgbed.haokun.me/file/1766409075347_image.png)



###### 其实连接海外VPS丢包太严重也可以用这种方法（比如魔法上网
